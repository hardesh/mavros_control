...
class Commander:
    def __init__(self):
        ...
        rate = rospy.Rate(20)
        self.position_target_pub = rospy.Publisher('/mavros/local_position/pose', PoseStamped, queue_size=10)
        # self.yaw_target_pub = rospy.Publisher('gi/set_pose/orientation', Float32, queue_size=10)
        # self.custom_activity_pub = rospy.Publisher('/mavros/set_mode', SetMode, queue_size=10)
